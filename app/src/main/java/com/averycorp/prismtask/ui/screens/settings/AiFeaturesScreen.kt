...
fun AiFeaturesScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { ThemedSubScreenTitle("AI Features") },
                navigationIcon = {
        ...
        Column(
            ...
            AiSection(
                ...
                onNavigateToPasteExtract = { navController.navigate(PrismTaskRoute.PasteConversation.route) },
                onNavigateToWeeklyReview = { navController.navigate(PrismTaskRoute.WeeklyReview.route) },
                onNavigateToMoodAnalytics = { navController.navigate(PrismTaskRoute.MoodAnalytics.route) },
                onNavigateToAiChat = { navController.navigate(PrismTaskRoute.AiChat.createRoute()) },
