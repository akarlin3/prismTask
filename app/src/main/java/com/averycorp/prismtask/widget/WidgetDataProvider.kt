    ...
    private fun getDb(context: Context): PrismTaskDatabase =
        Room.databaseBuilder(context, PrismTaskDatabase::class.java, "averytask.db")
            .addMigrations(
                ...
                PrismTaskDatabase.MIGRATION_7_8, PrismTaskDatabase.MIGRATION_8_9,
                PrismTaskDatabase.MIGRATION_9_10, PrismTaskDatabase.MIGRATION_10_11,
                PrismTaskDatabase.MIGRATION_11_12, PrismTaskDatabase.MIGRATION_12_13,
                PrismTaskDatabase.MIGRATION_13_14, PrismTaskDatabase.MIGRATION_14_15,
                PrismTaskDatabase.MIGRATION_15_16, PrismTaskDatabase.MIGRATION_16_17,
                PrismTaskDatabase.MIGRATION_17_18, PrismTaskDatabase.MIGRATION_18_19,
                PrismTaskDatabase.MIGRATION_19_20, PrismTaskDatabase.MIGRATION_20_21,
                PrismTaskDatabase.MIGRATION_21_22, PrismTaskDatabase.MIGRATION_22_23,
                PrismTaskDatabase.MIGRATION_23_24, PrismTaskDatabase.MIGRATION_24_25,
                PrismTaskDatabase.MIGRATION_25_26, PrismTaskDatabase.MIGRATION_26_27
            )
