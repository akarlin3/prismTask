 ...
 * subscription. All Calm Mode features and most ADHD Mode features are Free tier.
 * Only AI-powered features require Pro.
 */
object NdFeatureGate {

    /** Returns true if either ADHD Mode or Calm Mode (or both) are active. */
     ...
     *
     * Free features: all Calm Mode settings, manual task decomposition, focus guard,
     * basic completion animations, streak celebrations, progress bars, body doubling
     * with fixed-interval check-ins, forgiveness streaks.
     */
