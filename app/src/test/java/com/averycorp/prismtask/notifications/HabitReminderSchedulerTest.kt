...
/**
 * Tests for the pure companion helper in [HabitReminderScheduler]. This
...
class HabitReminderSchedulerTest {
    ...
    fun timeStringToNextTrigger_futureTimeTodayFiresToday() {
        ...
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("14:30", now)
    ...
    fun timeStringToNextTrigger_pastTimeRollsToNextDay() {
        ...
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("08:00", now)
    ...
    fun timeStringToNextTrigger_currentMinuteRollsForward() {
        ...
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("09:30", now)
    ...
    fun timeStringToNextTrigger_malformedStringFallsBackToDefaultHour() {
        ...
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("not:a:time", now)
    ...
    fun timeStringToNextTrigger_emptyStringFallsBackToDefaultHour() {
        val now = epochFor(hour = 0, minute = 0, daysFromEpoch = 10_000)
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("", now)
    ...
    fun timeStringToNextTrigger_midnightTimeIsHandled() {
        ...
        val trigger = HabitReminderScheduler.timeStringToNextTrigger("00:00", now)
